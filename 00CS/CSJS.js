	...
	if(!(await _0x374418()))return;else{
		...
		for(let i=0;i<var2.length;i++){
			...
			if(cookie.did&&cookie['kuaishou.api_st']&&cookie.client_salt){
				...
				$.cookie='kpn=NEBULA; kpf=ANDROID_PHONE; did=ANDROID_f5621b9eb4947d6c; language=zh-cn; countryCode=CN; sys=ANDROID_9; mod=meizu%2816s%29; net=WIFI; deviceName=meizu%2816s%29; isp=; app=0; bottom_navigation=true; oDid=TEST_ANDROID_f5621b9eb4947d6c; android_os=0; boardPlatform=msmnile; androidApiLevel=28; slh=0; nbh=96; hotfix_ver=; did_gt=1648004239891; keyconfig_state=2; max_memory=256; sh=2232; app_status=3; ddpi=480; browseType=3; power_mode=0; socName=Qualcomm+Snapdragon+8150; is_background=0; sw=1080; ftt=; apptype=22; device_abi=arm64; totalMemory=5498; iuid=; rdid=ANDROID_7f956bae415e4b7b; sbh=84; darkMode=false; client_key=2ac2a76d; userId=547039474; ud=547039474; did_tag=7; country_code=cn; grant_browse_type=AUTHORIZED; egid=DFPB35EF1B4B07B516868567568BBE8DD5DEEC3E63C2107247961D86EC60A266; c=ANDROID_MEIZU_MZ_SJCS_CPD_MEIZU_NEW_JS; ver=10.3; appver=10.3.31.3276; kcv=1461; newOc=ANDROID_MEIZU_MZ_SJCS_CPD_MEIZU_NEW_JS; sid=6098b483-efe2-4d07-ad7d-0c187453459f; cold_launch_time_ms=1653448512342; oc=ANDROID_MEIZU_MZ_SJCS_CPD_MEIZU_NEW_JS; deviceBit=3; abi=arm64; cl=0; userRecoBit=2; kuaishou.api_st=Cg9rdWFpc2hvdS5hcGkuc3QSoAGm8zrP7bwMephcd3U3iYw48GFkpEMcn8mFKFcKP4MEyEdS3sQIBW0v3ZUEjF7n0aIFh0i3VP4tPmph-5hzlh-1yNkTQGBGRoitYj-urYm41MiQMpmrEmQsUDrmJ4QODdAOb9ol56EyMPsKqKA8-JS0dvAeKIlBMeL7xPfUMnxLRqjz9s7LPjgnt2AxOl1uWwH8VqrOnOwdB_97fQJBqXnpGhLgtQndTL9KcIMccEKwrUv06E4iINEB3uRIG0w_GQw9hJ8tP40ow9ojWLE3TtpMpQFAn0TPKAUwAQ; token=Cg9rdWFpc2hvdS5hcGkuc3QSoAGm8zrP7bwMephcd3U3iYw48GFkpEMcn8mFKFcKP4MEyEdS3sQIBW0v3ZUEjF7n0aIFh0i3VP4tPmph-5hzlh-1yNkTQGBGRoitYj-urYm41MiQMpmrEmQsUDrmJ4QODdAOb9ol56EyMPsKqKA8-JS0dvAeKIlBMeL7xPfUMnxLRqjz9s7LPjgnt2AxOl1uWwH8VqrOnOwdB_97fQJBqXnpGhLgtQndTL9KcIMccEKwrUv06E4iINEB3uRIG0w_GQw9hJ8tP40ow9ojWLE3TtpMpQFAn0TPKAUwAQ; kuaishou.h5_st=Cg5rdWFpc2hvdS5oNS5zdBKQAfrlL7YAuH017WRQ5WIVfZBeL2BaFxWMBMBlzRTONS4gy9A4E002hKTkjLM6QStoaRtDLqkyWAwdjLz0neZjW5HT0lL1K0qFWAYY3uD28zWf-O_WXrAfZkLas-OVzZJnRcNEaFGwBi3kHgqjtMZ1psZy63ZUvEKRjC4lmeTQ_MXqNQhrooxXciCkx-NCerNnURoSIlRDjsU5GacdyB61xxNBrWYsIiCnVw-QUXITtUfZ7AlkpmNZiP8Hayyia6w6Wqh78lVu_SgFMAE; __NSWJ=6c7NeENVva3cp%2B84am%2BMwN87I0a0cOnsfT%2BPdulf%2FK9qKTG0zLpeCL6t2%2BuwYQItAAAACA%3D%3D';
				await getUserInfo();
				if($.nickname){
					var6.push($.nickname);
