...
isvtoken = "6537651a-5e23-4efd-b088-e2f6523eaeb7"#可能一天换一次   点赞浏览可能有问题，多执行几次总会成功
encryptionkey = "YZ1224404754630639616YZUYe7Wzax"#可能一周换一次   报错的自我反省，不要加我
unionId = "oQSRbs52Q-KlSBUkli4trPvg6f-c"
wxOpenId = "o0zsA5GeNcNfwNWuBwAt3sOj-ogE"
mobile = ""  #手机号
openId = "wFJfNHTa1138776542055235584"#,不报错不需要管
mntoken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTI1NzI4NDQsInVzZXJfaWQiOiJhZmE5ZjI0NjhlYWQ0ODA2OTM4MzBhMmI0ZTVmODk1NiIsImNsaWVudF9pZCI6IjZiOGQ4YzcyZjIxZjI0Nzg4ZCIsImFjdGl2aXR5X2lkIjoiOTAzMWVlNDk1NjA2NDNlYWExZDMxYTZkNzBiMzE4NmMiLCJtZXJjaGFudF9pZCI6IjEzMDE3NzkwOSJ9.pCGz14ybPvP9AdDykEofBf-y6SWOOf7M0zK4sylq-8M"  #蒙牛抽奖页面搜这个url里面请求体的token
mctoken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTI1NzI5MzksInVzZXJfaWQiOiIwYTllNzNmNTU4M2I0NjIwYWM3ZTdjYjMwNjczNDc1NyIsImNsaWVudF9pZCI6IjZiOGQ4YzcyZjIxZjI0Nzg4ZCIsImFjdGl2aXR5X2lkIjoiNTc2NjhmNTg4M2Y0NDliMTg2ZThiYmRkMGI3YmI2MDkiLCJtZXJjaGFudF9pZCI6IjEzMDE3NzkwOSJ9.EzOgtVCkycMRAcMWlY8by_peoKQRAaxVmIRr3PFE-R4"  #牧场抽奖页面搜这个url里面请求体的token
headers = {
...
data14 = json.dumps(data, separators=(',', ':'))
data15 = {
    "mobile": mobile,
    "storeId": 130177909,
    "actionName": "4月精选牧场签到",
