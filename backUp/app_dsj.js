...
[task_local]
#电视家
0 0 7,14 * * * https://github.com/JDWXX/jd_job/blob/master/qt/jd_dsj, tag=电视家, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "0 0 7,14 * * *" script-path=https://github.com/JDWXX/jd_job/blob/master/qt/jd_dsj,tag=电视家

===============Surge=================
电视家 = type=cron,cronexp="0 0 7,14 * * *",wake-system=1,timeout=33600,script-path=https://github.com/JDWXX/jd_job/blob/master/qt/jd_dsj

============小火箭=========
电视家 = type=cron,script-path=https://github.com/JDWXX/jd_job/blob/master/qt/jd_dsj, cronexpr="0 0 7,14 * * *", timeout=33600, enable=true
*/
const $ = new Env("电视家_非京东");
