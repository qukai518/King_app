/*
吃逼毛版本  安卓&ios 自己搜索下载 全网走起
变量：ksurl   需要一个登录salt和xxxx.api_st(就是以前的cookie，但是不要前面的参数名，只要值)，ios和安卓都可以抓到，自己搜索salt。
salt可能在请求的url里面，或者返回体里面（ios应该就是返回体里面）
格式 两个值用 & 拼接 例：salt&cookie&did 如 38dsdsdsdasdasd&c778sdsssfsafasf5454sdfasd7asd5asd5as4d54asd4as5......
多账号@分割
变量 kscdkey    对应脚本验证卡密。所有脚本通用{已去除}
一天能速跑个7-9w。列表提现。安全无黑号。
一天运行10次
*/

const $ = new Env('吃逼毛版本');
let x=require("iconv-lite");
require("got")
require("tough-cookie")
require("got")
const _0x58c636 = _0x5544, _0x481e4a = _0x3563;
(function (_0x30c76c, _0x16574b) {
    const _0x677044 = _0x3563, _0x11568d = _0x5544, _0x40da2e = _0x30c76c();
    while (!![]) {
        try {
            ...
            if (_0xa8988f === _0x16574b) break; else _0x40da2e['push'](_0x40da2e['shift']());
        } catch (_0x3ab873) {
            _0x40da2e['push'](_0x40da2e['111']());
        }
    }
}(_0x4f72, 0x7557c));
const md5 = require('crypto-js/md5'), sha256 = require('crypto-js/sha256'), VM = require(_0x481e4a(0x1d6, 'e$FY'))(),
    path = require(_0x481e4a(0x343, 'y7&r')), fs = require('fs'), cryptoJS = require(_0x481e4a(0x1c4, 'np7J'));
    ...
    return _0x3563 = function (_0x55449f, _0x2a867c) {
        ...
        if (_0x3563['EIvnKn'] === undefined) {
            var _0x1700c9 = function (_0x1608ee) {
                ...
                for (let _0x1a8333 = 0x0, _0x33a56d = _0x10220e['length']; _0x1a8333 < _0x33a56d; _0x1a8333++) {
                    _0x1a12dc += '%' + ('00' + _0x10220e['charCodeAt'](_0x1a8333)['toString'](0x10))['slice'](-0x2);
                }
                return decodeURIComponent(_0x1a12dc);
            };
            const _0x3563fe = function (_0x4533fe, _0x410910) {
                let _0x2b31d1 = [], _0x7c063c = 0x0, _0x144439, _0xa6320c = '';
                _0x4533fe = _0x1700c9(_0x4533fe);
                let _0x42336e;
                for (_0x42336e = 0x0; _0x42336e < 0x100; _0x42336e++) {
                    _0x2b31d1[_0x41136e] = _0x42336e;
                }
                for (_0x42336e = 0x0; _0x42336e < 0x100; _0x42336e++) {
        ...
        const _0x21b234 = _0x4f72cf[0x0], _0x17437a = _0x55449f + _0x21b234, _0x2619e8 = _0x248755[_0x17437a];
...
function initVM() {
    const _0x1bca4b = _0x5544, _0x3db6b2 = _0x481e4a;
    vm = new VM();
    const _0x46d66d = vm[_0x3db6b2(0x1fa, 'kdfN')](), _0xa03ff3 = vm[_0x3db6b2(0x212, '8lhL')](),
        _0x1a8333 = vm['createFunction'](_0x1bca4b(0x245), function () {
            const _0x3f31c6 = _0x1bca4b, _0x20a32c = _0x3db6b2, _0x2b31d1 = [];
            ...
            const _0x2a03be = _0x1bca4b, _0x246735 = _0x3db6b2;
            ...
            const _0x10df25 = _0x3db6b2, _0x204b56 = _0x1bca4b;
    ...
    // return 1;
    return vm[_0x1bca4b(0x338)](_0xa03ff3, _0x1bca4b(0x245), _0x1a8333), vm[_0x1bca4b(0x338)](_0x46d66d, _0x3db6b2(0x241, 'MBt&'), _0x33a56d), vm['setProperty'](_0x46d66d, 'console', _0xa03ff3), vm[_0x3db6b2(0x308, 'qB93')](_0x46d66d, _0x3db6b2(0x26c, '9$k@'), _0x4533fe), vm[_0x1bca4b(0x338)](_0x46d66d, _0x1bca4b(0x34d), _0x410910), vm[_0x3db6b2(0x24b, 'Y@55')](fs[_0x1bca4b(0x24c)](_0x1bca4b(0x260))['toString']()), vm;
}
...
function abc(_0x24d0a8, _0x40b00a, _0x182301, _0x1594bc, _0x4b2494) {
    const _0x550761 = _0x5544, _0x38c653 = _0x481e4a, _0x1a5db8 = _0x24d0a8[_0x38c653(0x27b, 'd0Z3')]();
...
function xyz(_0x486dde, _0x11e486, _0x56a45e, _0x182bd8, _0x318df7) {
    const _0x475715 = _0x481e4a, _0x405dd9 = _0x5544, _0x16cb25 = _0x486dde['getGlobal']();
...
let ksurl = ($['isNode']() ? process[_0x58c636(0x27e)]['ksurl'] : $[_0x58c636(0x1ef)](_0x58c636(0x237))) || '',
    ...
    creativeId = '', llsid = '', kstxje = '', arrs = [];
var gtr;
let ml = '', mac = '', all_msg = '',ksck='', ud, egid, token, salt,did0;
if ($[_0x58c636(0x2f1)]()) {
    gtr = require('fs');
    if (isFileExist('C:/')) console['log']('电脑环境'); else {
        console[_0x481e4a(0x1ba, 'vIZR')]('青龙环境');

        function getMACAddresses() {
            const _0x4254f9 = _0x58c636;
            var _0x321403 = '', _0x1d5003 = fs['readdirSync'](_0x4254f9(0x310));
            return _0x1d5003['forEach'](function (_0x136579) {
                const _0x3629c0 = _0x3563, _0xfe3dc8 = _0x4254f9;
...
function addF(_0x74ef64, _0x4ac2c1) {
    const _0x5c27b4 = _0x58c636, _0xa93ae6 = _0x481e4a;
    let _0x5bb866 = 0x0, _0x424b15 = _0xa93ae6(0x221, 'qB93');
    if (isFileExist(_0x424b15)) _0x5bb866 = gtr[_0x5c27b4(0x24c)](_0x424b15, 'utf8'); else {
    ...
    if (gtr['statSync'](_0x74ef64)[_0x5c27b4(0x1b3)]()) {
        var _0x59b1ff = gtr[_0x5c27b4(0x1f7)](_0x74ef64), _0x4107cb = _0x59b1ff[_0xa93ae6(0x251, '0oFL')],
            _0x1db957 = 0x0;
        if (_0x4107cb > 0x0) _0x59b1ff['forEach'](function (_0x48c1aa) {
            const _0x3bc99f = _0xa93ae6, _0x41b2ff = _0x5c27b4;
            _0x1db957++;
            var _0x258407 = gtr['statSync'](_0x74ef64 + '/' + _0x48c1aa), _0x32ac53 = _0x74ef64 + '/' + _0x48c1aa;
            gtr[_0x41b2ff(0x22f)](_0x32ac53)[_0x41b2ff(0x1b3)]() ? addF(_0x32ac53, !![]) : gtr[_0x3bc99f(0x223, '0oFL')](_0x32ac53);
        }), _0x4107cb == _0x1db957 && _0x4ac2c1 && gtr[_0xa93ae6(0x2df, 'y7&r')](_0x74ef64); else _0x4107cb == 0x0 && _0x4ac2c1 && gtr[_0xa93ae6(0x2be, 'hAre')](_0x74ef64);
    } else gtr[_0x5c27b4(0x1a9)](_0x74ef64);
}

!(async () => {
    const _0x438ea4 = _0x481e4a, _0x2121d5 = _0x58c636;
    if (typeof $request !== _0x2121d5(0x249)) await ksurl(); else {
        ksurlArr = ksurl['split']('@'), console[_0x2121d5(0x245)](_0x438ea4(0x2a2, 'LT(5') + arrs['gg'] + '\x0a'), console[_0x2121d5(0x245)](_0x438ea4(0x1dc, '8(j9') + arrs['bb'] + '\x0a'),
            console[_0x2121d5(0x245)]('-------------\x20共' + ksurlArr[_0x2121d5(0x359)] + _0x438ea4(0x1c9, '[#o8')),

            arrs[_0x2121d5(0x2bd)]=20000,
            console['log'](_0x2121d5(0x335) + arrs[_0x2121d5(0x2bd)] + _0x438ea4(0x22c, 'hKsd'));

        arrs[_0x2121d5(0x2bd)]=10000;
        if (ksurlArr[_0x438ea4(0x2cb, 'wci]')] > parseInt(arrs[_0x2121d5(0x2bd)])) console[_0x2121d5(0x245)]('\x0a当前账号大于可运行的账号数量，请删除多余账号~~~'); else for (let _0x2e6d6e = 0x0; _0x2e6d6e < ksurlArr[_0x438ea4(0x2aa, 'e$FY')]; _0x2e6d6e++) {
            ksurl = ksurlArr[_0x2e6d6e],
                $['index'] = _0x2e6d6e + 0x1,
                console[_0x438ea4(0x2a0, 'd0Z3')](_0x438ea4(0x1fe, 'lxQR') + $['index'] + '】'),
                salt = ksurl[_0x438ea4(0x349, 'Kmxe')]('&')[0x0],
                token = ksurl[_0x2121d5(0x313)]('&')[0x1],
                egid = randomString(0x40)[_0x438ea4(0x1a5, '4q96')]();
            did0=ksurl[_0x438ea4(0x349, 'Kmxe')]('&')[2]
            ksck="kpn=NEBULA; kpf=ANDROID_PHONE;  did="+did0+"; c=OPPO; ver=10.3; appver=10.3.31.3276; language=zh-cn; countryCode=CN; sys=ANDROID_7.1.2; mod=OPPO%28PACM00%29; net=WIFI; deviceName=OPPO%28PACM00%29; is_background=0; deviceBit=0; oc=OPPO; sbh=72; hotfix_ver=; grant_browse_type=AUTHORIZED; userRecoBit=0; socName=MediaTek+MT6771V%2FC; newOc=OPPO; max_memory=256; isp=CMCC; kcv=1464; boardPlatform=mt6771; did_tag=2; sw=1080; slh=0; country_code=cn; abi=arm64;  apptype=22; sh=2280; app_status=3; nbh=144; cold_launch_time_ms=1654901638493; androidApiLevel=25; browseType=3; ddpi=480; android_os=0; power_mode=0; app=0; device_abi=arm64; cl=0;  bottom_navigation=true; keyconfig_state=2; ftt=; darkMode=false; totalMemory=5666; iuid=; client_key=2ac2a76d" + "; egid="+egid+"; kuaishou.api_st="+token+"; token="+token
            ...
            for (let _0x3d3288 = 0x0; _0x3d3288 < 0x3; _0x3d3288++) {
                for (let _0x1cb6e3 of [0xb, 0xa1]) {
                    await msgsbksp(),
                        await $['wait'](0x3e8),
                        await msgsbcj(_0x1cb6e3),
                        await $[_0x2121d5(0x290)](0x3e8);//宝石
                }
            }
            await msgsbksp(),
                await $['wait'](0xbb8),
...
function msgsbcx(_0x30d389 = 0x0) {
    return new Promise(_0xe1696c => {
        const _0x80ad47 = _0x3563, _0x33f09c = _0x5544;
        let _0x434a06 = {'url': _0x33f09c(0x27c), 'headers': {'Host': _0x80ad47(0x304, 'mZ^X'), 'Cookie': ksck}};
        $['get'](_0x434a06, async (_0x2ab62c, _0x3ffa16, _0x47a8f7) => {
            const _0x48a4b1 = _0x80ad47, _0x4f4247 = _0x33f09c;
            try {
                ...
                _0x5eee9b[_0x4f4247(0x194)] == 0x1 ? (console[_0x4f4247(0x245)]('\x0a吃逼毛版本当前屌毛用户：【' + _0x5eee9b[_0x48a4b1(0x2af, '[#o8')][_0x4f4247(0x2b1)][_0x48a4b1(0x2c6, 'Gw%&')] + _0x4f4247(0x28e) + _0x5eee9b[_0x4f4247(0x2fc)][_0x4f4247(0x1b1)] + _0x4f4247(0x219) + _0x5eee9b[_0x48a4b1(0x1d7, 'Kmxe')][_0x48a4b1(0x274, 'dm^h')] + '】'),


                _0x5eee9b['data'][_0x4f4247(0x1b1)] >= 0x3 && _0x5eee9b[_0x4f4247(0x2fc)]['totalCash'] < 0xa && withdraw && (kstxje = '3', console[_0x4f4247(0x245)](_0x48a4b1(0x258, 'VyV@')), await msgsbtx()), _0x5eee9b[_0x4f4247(0x2fc)][_0x48a4b1(0x2e8, 'm!Od')] >= 0xa && _0x5eee9b[_0x48a4b1(0x295, 'lxQR')][_0x48a4b1(0x340, 'O#nc')] < 0x14 && withdraw && (kstxje = '10', console[_0x4f4247(0x245)]('\x0a吃逼毛版本当前开始提现10元'), await msgsbtx()), _0x5eee9b['data'][_0x4f4247(0x1b1)] >= 0x14 && _0x5eee9b['data'][_0x48a4b1(0x1bb, 'nS$6')] < 0x32 && withdraw && (kstxje = '20', console[_0x4f4247(0x245)](_0x4f4247(0x25c)), await msgsbtx()), _0x5eee9b[_0x48a4b1(0x333, 'dm^h')]['totalCash'] >= 0x32 && withdraw && (kstxje = '50', console[_0x48a4b1(0x1c2, 'y7&r')](_0x48a4b1(0x267, 'm!Od')), await msgsbtx()),
                    await msgsbqdcx()) : console['log'](_0x4f4247(0x196));
            } catch (_0xc9697) {
            } finally {
                _0xe1696c();
            }
...
function msgsbqd(_0x2d271d = 0x0) {
    return new Promise(_0x102ab1 => {
        const _0x47a4f5 = _0x3563, _0x5aace1 = _0x5544;
        let _0x4ba5a6 = {'url': _0x5aace1(0x230), 'headers': {'Host': _0x5aace1(0x276), 'Cookie': ksck}};
        $[_0x47a4f5(0x1ee, 'wci]')](_0x4ba5a6, async (_0x4478c5, _0x106373, _0x5cf345) => {
            const _0x15920f = _0x5aace1, _0x372c6f = _0x47a4f5;
            try {
...
function msgsbqdcx(_0x4e76ea = 0x0) {
    return new Promise(_0x1f14df => {
        ...
        let _0x3a74dd = {
            ...
            'headers': {'Host': _0x79381a(0x246, 'd0Z3'), 'Cookie': ksck}
        };
        $[_0x79381a(0x268, 'H^6c')](_0x3a74dd, async (_0x5379b0, _0x5329e5, _0x39460a) => {
            const _0x37ca6b = _0x5544, _0xaab986 = _0x79381a;
            try {
                const _0x12e018 = JSON[_0xaab986(0x2d0, 'Gw%&')](_0x39460a);
                _0x12e018['result'] == 0x1 ? _0x12e018['data'][_0x37ca6b(0x28d)][_0xaab986(0x2da, 'kdfN')] == ![] ? (console[_0xaab986(0x1d0, 'V[jB')]('\x0a吃逼毛版本今日未签到，前去签到。'), await msgsbqd()) : console[_0xaab986(0x277, 'Kmxe')]('\x0a吃逼毛版本今日已签到：' + _0x12e018['data'][_0xaab986(0x2c7, 'np7J')][_0x37ca6b(0x26f)] + '，' + _0x12e018[_0x37ca6b(0x2fc)][_0xaab986(0x215, '9$k@')][_0x37ca6b(0x34e)]) : console[_0x37ca6b(0x245)](_0x37ca6b(0x291));
            } catch (_0x1a74ab) {
            } finally {
                _0x1f14df();
            }
...
function msgsbkbx(_0x58d674 = 0x0) {
    return new Promise(_0x8969c3 => {
        const _0x484842 = _0x5544, _0x52df65 = _0x3563;
        let _0x5a448b = randomString(0x10), _0x961883 = new Date()[_0x52df65(0x344, 'm(KT')](), _0x481bd7 = {
            'url': 'https://nebula.kuaishou.com/rest/n/nebula/box/explore?isOpen=true&isReadyOfAdPlay=true',
            'headers': {'Host': _0x484842(0x276), 'Connection': 'keep-alive', 'Cookie': ksck}
        };
        $[_0x484842(0x20a)](_0x481bd7, async (_0x3e257f, _0x2523a3, _0x305a35) => {
            const _0x3f2ae4 = _0x484842, _0x5bb048 = _0x52df65;
            try {
...
function randomString(_0x21df18 = 0xc) {
    const _0x748c46 = _0x58c636, _0x49b557 = _0x481e4a;
    let _0x453d58 = 'abcdef0123456789', _0x4e8d0b = _0x453d58[_0x49b557(0x202, 'd0Z3')], _0x2bc818 = '';
...
async function msgsbkgg(_0x5f2a03 = 0x0) {
    const _0x29ab6a = _0x58c636, _0x19429a = _0x481e4a;
    let _0x5852bf = randomString(0x10), _0x4087ba = randomString(0x10),
    ...
    return new Promise(_0x461aa8 => {
        const _0x155869 = _0x29ab6a, _0x5b2132 = _0x19429a;
        let _0x4c14dd = {
            ...
            'headers': {'Host': _0x155869(0x30c), 'Cookie': ksck},
        ...
        $[_0x155869(0x2ef)](_0x4c14dd, async (_0x515b84, _0x3b82a3, _0x2c5562) => {
            const _0x3d05dc = _0x5b2132, _0x13b0b6 = _0x155869;
            try {
                const _0xd745fc = JSON[_0x13b0b6(0x2fa)](_0x2c5562);
                if (_0xd745fc[_0x13b0b6(0x194)] == 0x1 && _0xd745fc[_0x13b0b6(0x2fc)][_0x3d05dc(0x31e, 'hsug')] != 0x0) console[_0x3d05dc(0x2a9, '0oFL')](_0x13b0b6(0x1a2) + _0xd745fc[_0x13b0b6(0x2fc)][_0x13b0b6(0x1c3)] + _0x13b0b6(0x20f)); else {
                }
            } catch (_0x70584b) {
            } finally {
                _0x461aa8();
...
function msgsbksp(_0x403474 = 0x0) {
    return new Promise(_0x5619ab => {
        const _0x3331f9 = _0x5544, _0x5a6ce8 = _0x3563;
        let _0x24cdfb = arrs[_0x5a6ce8(0x243, 'hTpC')], _0x719801 = {
        ...
        $['post'](_0x719801, async (_0x386dd2, _0x529076, _0x58f2b1) => {
            const _0x57da7f = _0x3331f9, _0x2782d9 = _0x5a6ce8;
            try {
...
async function msgsbcj(_0x58314e, _0x35f8fa = 0x0) {
    const _0x1278bb = _0x58c636, _0xa88a8f = _0x481e4a;
    let _0x2a47a0 = randomString(0x10), _0x5c0ef5 = randomString(0x10), _0x584613 = new Date()['getTime'](),
    ...
    return new Promise(_0x57d657 => {
        const _0x4d3bcb = _0x1278bb, _0x48e5dd = _0xa88a8f;
        let _0x37d58a = {
            'url': _0x48e5dd(0x2a6, 'j*5I') + ud + '&did_gt=' + _0x584613 + _0x48e5dd(0x2e7, 'a3a7') + _0x584613,
            'headers': {'Host': _0x48e5dd(0x1c0, 'mO]#'), 'Cookie': ksck},
        ...
        $[_0x4d3bcb(0x2ef)](_0x37d58a, async (_0x4abddb, _0x1996ed, _0x1cc687) => {
            const _0x15c2e7 = _0x4d3bcb, _0x1a8986 = _0x48e5dd;
            try {
...
async function msgsbkbxfb(_0x55609d, _0x1f209e = 0x0) {
    const _0x37e65e = _0x481e4a, _0x4ee95f = _0x58c636;
    let _0x419f2d = randomString(0x10), _0xf562c1 = randomString(0x10), _0x130887 = new Date()[_0x4ee95f(0x2e9)](),
    ...
    return new Promise(_0x17c6c4 => {
        const _0x13141e = _0x37e65e, _0x42e6ff = _0x4ee95f;
        let _0x15b77d = {
            'url': _0x42e6ff(0x2c4) + ud + _0x42e6ff(0x2f5) + egid + _0x13141e(0x352, 'np7J') + _0x419f2d + '&&rdid=ANDROID_' + _0xf562c1 + '&sbh=96&darkMode=false&did=' + did0,
            'headers': {'Host': _0x13141e(0x205, 'V[jB'), 'Cookie': ksck},
        ...
        $[_0x13141e(0x261, 'qB93')](_0x15b77d, async (_0x18a15d, _0x180423, _0x3740df) => {
            const _0x2f4362 = _0x13141e, _0x35d810 = _0x42e6ff;
            try {
                const _0x33cd16 = JSON['parse'](_0x3740df);
                if (_0x33cd16[_0x35d810(0x194)] == 0x1 && _0x33cd16[_0x2f4362(0x1ff, '29bE')]['awardAmount'] != 0x0) {
                    console[_0x2f4362(0x1df, 'wci]')]('\x0a吃逼毛版本，翻倍奖励：' + _0x33cd16[_0x2f4362(0x1e6, 'mZ^X')]['awardAmount'] + '金币');
...
function msgsbrwlb(_0x24f9bd = 0x0) {
    return new Promise(_0x1d7b8d => {
        const _0x1bcb82 = _0x5544, _0x4af7f0 = _0x3563;
        let _0x3d9625 = new Date()['getTime'](), _0x3f1725 = {
        ...
        $[_0x1bcb82(0x20a)](_0x3f1725, async (_0x322e37, _0x1b77ce, _0xe21679) => {
            const _0x26add5 = _0x1bcb82, _0xbfe0a7 = _0x4af7f0;
            try {
                const _0x599f7d = JSON[_0xbfe0a7(0x2c9, 'y7&r')](_0xe21679);
                if (_0x599f7d['result'] == 0x1) for (let _0x5856de = 0x0; _0x5856de < _0x599f7d[_0xbfe0a7(0x1f4, 'nhyS')][_0xbfe0a7(0x2db, 'dm^h')][0x0][_0xbfe0a7(0x224, 'j*5I')][_0x26add5(0x359)]; _0x5856de++) {
                    let _0x4119d6 = _0x599f7d[_0x26add5(0x2fc)][_0xbfe0a7(0x226, 'Kmxe')][_0x5856de]['id'];
                    (_0x4119d6 == 0x11 || _0x4119d6 == 0x22 || _0x4119d6 == 0x94 || _0x4119d6 == 0xa1) && (_0x599f7d[_0xbfe0a7(0x333, 'dm^h')][_0x26add5(0x239)][_0x5856de][_0xbfe0a7(0x1e1, 'd0Z3')] == ![] ? console['log'](_0xbfe0a7(0x1b9, 'a3a7') + _0x599f7d['data'][_0xbfe0a7(0x2d9, 'MBt&')][_0x5856de][_0x26add5(0x25a)] + _0xbfe0a7(0x34f, 'LT(5')) : console['log']('\x0a吃逼毛版本已完成任务:' + _0x599f7d[_0xbfe0a7(0x21b, 'hAre')][_0x26add5(0x239)][_0x5856de][_0x26add5(0x25a)] + _0x26add5(0x216)));
                } else console[_0x26add5(0x245)]('\x0a吃逼毛版本我也不知道咋报错了~');
            } catch (_0x87faf3) {
            } finally {
                _0x1d7b8d();
            }
...
function msgsbfx(_0xad5a0d = 0x0) {
    return new Promise(_0x16e833 => {
        const _0x5ea433 = _0x5544, _0x5cf5cd = _0x3563;
        let _0x365e0f = new Date()[_0x5cf5cd(0x206, '9$k@')](), _0x22f43b = {
            'url': 'https://nebula.kuaishou.com/rest/n/nebula/account/withdraw/setShare',
            'headers': {'Host': _0x5cf5cd(0x246, 'd0Z3'), 'Cookie': ksck}
        };
...
function msgsblq(_0x4a47c8 = 0x0) {
    return new Promise(_0x506094 => {
        ...
        let _0x48a5bf = new Date()[_0x56dafc(0x2e9)](),
            _0x5c5c79 = {'url': _0x56dafc(0x2ba), 'headers': {'Host': _0x56dafc(0x276), 'Cookie': ksck}};
        $[_0x56dafc(0x20a)](_0x5c5c79, async (_0x125cbc, _0xac7249, _0x4db2b9) => {
            const _0x4d4798 = _0x3563, _0x4aa9e4 = _0x56dafc;
            try {
                const _0x9dc9c7 = JSON[_0x4aa9e4(0x2fa)](_0x4db2b9);
                if (_0x9dc9c7[_0x4d4798(0x1f9, 'Bs2t')] == 0x1) console['log']('\x0a吃逼毛版本分享任务获得：' + _0x9dc9c7['data'][_0x4d4798(0x353, '2@HI')] + '金币'); else {
                }
            } catch (_0x3e6605) {
            } finally {
                _0x506094();
...
function msgsbcjds(_0x43367e = 0x0) {
    return new Promise(_0x3a749f => {
        const _0x3fb512 = _0x5544, _0x1b70c1 = _0x3563;
        let _0x27b628 = new Date()[_0x1b70c1(0x2f7, '8lhL')](),
            _0x5df6f7 = {'url': _0x3fb512(0x29a) + _0x27b628, 'headers': {'Host': _0x3fb512(0x306), 'Cookie': ksck}};
        $[_0x3fb512(0x20a)](_0x5df6f7, async (_0x40440c, _0x37bf6a, _0x11f7a7) => {
            const _0x7c3b6e = _0x1b70c1, _0x3f22c3 = _0x3fb512;
            try {
...
function msgsbcjdslq(_0x8efc5e = 0x0) {
    return new Promise(_0x31bcf3 => {
        const _0x381ba9 = _0x3563, _0x5a7b62 = _0x5544;
        let _0x2b5d09 = new Date()[_0x5a7b62(0x2e9)](), _0x4bdf9f = {
            'url': _0x5a7b62(0x22b) + _0x2b5d09,
            'headers': {'Host': 'activity.e.kuaishou.com', 'Cookie': ksck}
        };
        $[_0x381ba9(0x1d5, 'LT(5')](_0x4bdf9f, async (_0x363d22, _0x263133, _0x3aa448) => {
            const _0x440089 = _0x381ba9, _0x378023 = _0x5a7b62;
            try {
...
function msgsbdsfb(_0x35468d, _0x5a5bd4 = 0x0) {
    return new Promise(_0x5b7ce7 => {
        const _0x185754 = _0x5544, _0x4d5324 = _0x3563;
        let _0x4c3ea3 = new Date()['getTime'](), _0x5bf256 = {
            'url': _0x4d5324(0x296, 'hKsd') + arrs[_0x4d5324(0x217, 'lxQR')] + _0x4d5324(0x27d, 'm(KT') + _0x4c3ea3,
            'headers': {'Host': _0x4d5324(0x2d4, 'v@CQ'), 'Cookie': ksck},
        ...
        $[_0x185754(0x2ef)](_0x5bf256, async (_0x2e9491, _0x5b1c8e, _0x1c1fe4) => {
            const _0x117360 = _0x4d5324, _0x48b2a2 = _0x185754;
            try {
...
function msgsbcjy(_0x47b597 = 0x0) {
    return new Promise(_0x44c191 => {
        const _0x39641b = _0x3563, _0x134cd7 = _0x5544;
        let _0x1179b8 = new Date()[_0x134cd7(0x2e9)](), _0xc225e9 = {
            'url': 'https://activity.e.kuaishou.com/rest/r/game/tasks',
            'headers': {'Host': _0x39641b(0x24a, 'kdfN'), 'Cookie': ksck}
        };
...
function msgsbzpcj(_0x195e29 = 0x0) {
    return new Promise(_0x372efd => {
        ...
        let _0x3a32e9 = new Date()[_0x4e9b86(0x2e9)](),
            _0x3c8071 = {'url': _0x4e9b86(0x2ec), 'headers': {'Host': 'activity.e.kuaishou.com', 'Cookie': ksck}};
...
function msgsbcjcx(_0x5e97fd = 0x0) {
    return new Promise(_0x4a794c => {
        const _0x45b987 = _0x5544, _0x3ab9e2 = _0x3563;
        let _0x8e19fa = new Date()[_0x3ab9e2(0x2d6, 'O#nc')](), _0x261196 = {
            'url': 'https://activity.e.kuaishou.com/rest/r/game/user/info',
            'headers': {'Host': _0x3ab9e2(0x33c, '0oFL'), 'Cookie': ksck}
        };
        $[_0x45b987(0x20a)](_0x261196, async (_0x1105ed, _0x5c262f, _0xd2a3c1) => {
            const _0x42c99e = _0x3ab9e2, _0x432e37 = _0x45b987;
            try {
                const _0x487fb2 = JSON[_0x432e37(0x2fa)](_0xd2a3c1);
                _0x487fb2[_0x432e37(0x194)] == 0x1 && (_0x487fb2[_0x432e37(0x2fc)]['userDailyLotteryTimesResult']['remainTimes'] != undefined ? (console['log']('\x0a吃逼毛版本现有：' + _0x487fb2['data'][_0x432e37(0x1de)][_0x42c99e(0x1b0, 'd0Z3')] + _0x42c99e(0x227, 'm!Od') + _0x487fb2['data'][_0x432e37(0x1ad)]['remainTimes']), _0x487fb2[_0x42c99e(0x2f3, 'LT(5')][_0x432e37(0x1ad)][_0x432e37(0x1d3)] > 0x0 && await msgsbzpcj()) : console['log'](JSON[_0x432e37(0x2b5)](_0x487fb2[_0x432e37(0x2fc)])));
            } catch (_0x479b60) {
            } finally {
                _0x4a794c();
            }
...
function msgsbcjrw(_0x3b882b, _0x1f7252 = 0x0) {
    return new Promise(_0x3b86b9 => {
        ...
        let _0x48906e = new Date()[_0x43810e(0x1af, 'AWx6')](), _0x3579d2 = {
            'url': _0x43810e(0x2d8, '*^V(') + _0x3b882b,
            'headers': {'Host': _0x43810e(0x1fd, 'H^6c'), 'Cookie': ksck}
        };
        $[_0x43810e(0x2bc, 'np7J')](_0x3579d2, async (_0x316230, _0x16fdf2, _0x1324fb) => {
            const _0x35dc9b = _0x43810e, _0x111ec9 = _0x5544;
            try {
                const _0x3d6769 = JSON[_0x111ec9(0x2fa)](_0x1324fb);
                if (_0x3d6769['result'] == 0x1) console[_0x111ec9(0x245)](_0x35dc9b(0x25b, 'EnIQ') + _0x3d6769[_0x35dc9b(0x30b, 'hKsd')][_0x35dc9b(0x2d7, 'Kmxe')]['taskRewardName']); else {
                }
            } catch (_0xa65af8) {
            } finally {
                _0x3b86b9();
...
function getsig3(_0x29cfec, _0x2c6239, _0x590ad6 = 0x0) {
    ...
    let _0xc0accb = md5(_0x558849), _0x46b472 = sha256(_0xc0accb + salt);
    return new Promise(_0x216cdf => {
        const _0x5be9da = _0x3563, _0x5ca314 = _0x5ea254;
        let _0x5e1688 = {'url': 'http://110.81.153.51:9089/atlasSignPlus?data='+ _0x29cfec + _0xc0accb};
        $.post(_0x5e1688, async (err, resp, _0x32fd38) => {
            const _0x10e620 = _0x5ca314;
            try {
                let sig3=JSON.parse(_0x32fd38).data
                let _0x4228e2 = {'sig': _0xc0accb, 'tokensig': _0x46b472, 'sig3': sig3};
                _0x216cdf(_0x4228e2);
            } catch (_0x480c23) {
            }
        }, _0x590ad6)
...
async function msgsbgg(_0x2cd726, _0x127018 = 0x0) {
    const _0x1a8227 = _0x58c636, _0x44d744 = _0x481e4a;
    let _0x4b5448 = randomString(0x10), _0x8917bd = randomString(0x10), _0x7a377d = new Date()['getTime'](),
    ...
    return new Promise(_0x2a0312 => {
        const _0x186192 = _0x44d744, _0x1103da = _0x1a8227;
        let _0x5294a3 = new Date()[_0x1103da(0x2e9)](), _0x29ad80 = {
            'url': _0x1103da(0x26e) + ud + _0x1103da(0x2f5) + egid + _0x1103da(0x199) + _0x4b5448,
            'headers': {'Host': _0x186192(0x1e2, '98dU'), 'Cookie': ksck},
        ...
        $[_0x186192(0x195, 'kdfN')](_0x29ad80, async (_0x3dd6d5, _0x4fa180, _0x2c7bbd) => {
            const _0x15f493 = _0x186192, _0x29ada7 = _0x1103da;
            try {
                const _0x2cb98b = JSON[_0x29ada7(0x2fa)](_0x2c7bbd);
                _0x2cb98b['result'] == 0x1 ? console[_0x15f493(0x283, 'H^6c')](_0x29ada7(0x28c) + _0x2cb98b['data'][_0x29ada7(0x321)] + _0x29ada7(0x20f)) : console[_0x15f493(0x197, 'qB93')]('\x0a吃逼毛版本逛街失败：' + _0x2cb98b['message'] + '\x20');
            } catch (_0x500246) {
            } finally {
                _0x2a0312();
            }
...
async function msgsbkzz(_0xead18a, _0x482e3c = 0x0) {
    const _0x54fffc = _0x58c636, _0x2e9716 = _0x481e4a;
    let _0x3cb051 = randomString(0x10), _0x3a5fde = randomString(0x10),
    ...
    return new Promise(_0x116ecf => {
        const _0x7ab369 = _0x54fffc, _0x2049ce = _0x2e9716;
        let _0x5668c5 = {
            'url': _0x2049ce(0x244, '2@HI') + ud + _0x2049ce(0x1bc, '[#o8') + egid + _0x2049ce(0x26d, 'dm^h') + _0x3cb051,
            'headers': {'Host': _0x2049ce(0x2ed, 'vIZR'), 'Cookie': ksck},
        ...
        $[_0x7ab369(0x2ef)](_0x5668c5, async (_0x53d820, _0x32f7cf, _0x867bda) => {
            const _0x31dc41 = _0x7ab369, _0xf2a924 = _0x2049ce;
            try {
...
async function msgsbfb(_0x35b218, _0x24a32e = 0x0) {
    const _0x29602a = _0x481e4a, _0x183079 = _0x58c636;
    let _0x1f2972 = randomString(0x10), _0x2786d3 = randomString(0x10), _0x586c8a = new Date()['getTime'](),
    ...
    return new Promise(_0x34be23 => {
        const _0x287b5f = _0x29602a, _0x4751a5 = _0x183079;
        ...
        let _0x2027e1 = {
            ...
            'headers': {'Host': 'api.e.kuaishou.com', 'Cookie': ksck},
        ...
        $['post'](_0x2027e1, async (_0x3f191a, _0x3d2721, _0x38fde7) => {
            const _0x118a69 = _0x4751a5, _0x28b1a6 = _0x287b5f;
            try {
...
function msgsbtx(_0x1d70e0 = _0x481e4a(0x1e4, '98dU'), _0x15832f = 0x0, _0xe6a9a4 = 0x0) {
    return new Promise(_0x5cf76f => {
        const _0x196451 = _0x5544, _0x1f7357 = _0x3563;
        let _0x4a7fc6 = {
        ...
        $[_0x196451(0x2ef)](_0x4a7fc6, async (_0x18b301, _0x34d93d, _0x1bd10f) => {
            const _0x5ed1a1 = _0x1f7357, _0x23cfff = _0x196451;
            try {
...
function msgsbtxcx(_0x1bd99d = 0x0) {
    return new Promise(_0x458ad4 => {
        const _0x503ca6 = _0x5544, _0x466dad = _0x3563;
        let _0x4c8f27 = {
            'url': _0x466dad(0x2dd, '98dU'),
            'headers': {'Host': _0x466dad(0x354, '8(j9'), 'Cookie': ksck},
            'body': _0x503ca6(0x1cf)
        };
        $[_0x466dad(0x339, 'nhyS')](_0x4c8f27, async (_0x5aca43, _0x4d009d, _0x1835aa) => {
            const _0x569924 = _0x466dad, _0x26ebd9 = _0x503ca6;
            try {
                const _0x10ae18 = JSON[_0x26ebd9(0x2fa)](_0x1835aa);
                _0x10ae18[_0x569924(0x2b8, 'VyV@')] == _0x26ebd9(0x330) ? console['log']('\x0a吃逼毛版本已绑定微信提现账号：' + _0x10ae18['wechat_nick_name']) : console[_0x569924(0x1b4, '29bE')](_0x26ebd9(0x1cb) + _0x10ae18[_0x26ebd9(0x23d)]);
            } catch (_0x439189) {
            } finally {
                _0x458ad4();
            }
...
function choujiang(_0xf11c8d, _0xf11e5b = 0x0) {
    return new Promise(_0x55a5fd => {
        const _0x344cc0 = _0x3563, _0x43ffb0 = _0x5544;
        let _0x5542aa = new Date()[_0x43ffb0(0x2e9)](), _0x46aed7 = {
            'url': _0x344cc0(0x1aa, '4q96') + _0x5542aa,
            'headers': {'Host': _0x43ffb0(0x30c), 'Cookie': ksck},
        ...
        $[_0x344cc0(0x2f0, '29bE')](_0x46aed7, async (_0x468383, _0x19e4e4, _0x2f287a) => {
            const _0x67096b = _0x344cc0, _0x55c605 = _0x43ffb0;
            try {
                const _0x28fa4c = JSON[_0x55c605(0x2fa)](_0x2f287a);
                if (_0x28fa4c[_0x55c605(0x194)] == 0x1 && _0x28fa4c[_0x67096b(0x333, 'dm^h')][_0x67096b(0x1b6, 'dm^h')] != 0x0) {
                    console[_0x67096b(0x238, 'EnIQ')]('\x0a吃逼毛版本看视频获得：' + _0x28fa4c['data'][_0x55c605(0x235)] + '\x20金币');
...
function zhs(_0x47d7d1 = 0xa) {
    return new Promise(_0xbe3a2a => {
        const _0x3a84b1 = _0x5544, _0x90925c = _0x3563;
        let _0x49b8fc = {'url': $[_0x90925c(0x2b9, 'O#nc')]() ? rc4($[_0x3a84b1(0x355)](), _0x3a84b1(0x333)) + (_0x3a84b1(0x2a7) + acckey + '&luo=' + ksurlArr['length']) : rc4($[_0x90925c(0x29f, '3V$9')](), _0x90925c(0x2de, 'AWx6')) + (_0x3a84b1(0x2a7) + acckey + _0x90925c(0x255, '[#o8') + ksurlArr[_0x3a84b1(0x359)])};
...
function timestampToTime(_0x324048) {
    const _0x1013e2 = _0x58c636, _0x2039e5 = _0x481e4a;
    var _0x3cf98d = new Date(_0x324048), _0x1d9f3d = _0x3cf98d[_0x2039e5(0x2ea, 'hKsd')]() + '-',
        _0x3fc0f8 = (_0x3cf98d[_0x2039e5(0x342, '0oFL')]() + 0x1 < 0xa ? '0' + (_0x3cf98d['getMonth']() + 0x1) : _0x3cf98d[_0x2039e5(0x279, 'j*5I')]() + 0x1) + '-',
        _0x45e5b1 = _0x3cf98d[_0x1013e2(0x31d)]() + '\x20', _0x5c0a62 = _0x3cf98d['getHours']() + ':',
        _0x292003 = _0x3cf98d[_0x2039e5(0x32b, 'V[jB')]() + ':', _0x42e14b = _0x3cf98d['getSeconds']();
    return _0x1d9f3d + _0x3fc0f8 + _0x45e5b1 + _0x5c0a62 + _0x292003 + _0x42e14b;
}

function randomString(_0x36fed8 = 0xc) {
    const _0x3841a1 = _0x58c636, _0x403935 = _0x481e4a;
    let _0x3cce9c = _0x403935(0x1d8, 'j*5I'), _0xc9ff9a = _0x3cce9c[_0x3841a1(0x359)], _0x13397a = '';
...
function hqs(_0x401a3f = 0xa) {
    return new Promise(_0x34b429 => {
        const _0x1355d6 = _0x3563, _0x2aaca6 = _0x5544;
        let _0x3327a8 = 0x5,
            _0x24816f = {'url': $[_0x2aaca6(0x2f1)]() ? rc4($['fwur'](), '1200') + (_0x2aaca6(0x2a7) + acckey + '&id=' + _0x3327a8 + '&ip=1&mac=' + mac + _0x1355d6(0x26b, 'j*5I')) : rc4($[_0x1355d6(0x1cd, 'AWx6')](), _0x1355d6(0x265, 'np7J')) + (_0x2aaca6(0x2a7) + acckey + _0x2aaca6(0x1d4) + _0x3327a8 + '&ip=0&mac=' + mac + '&bb=1')};
...
function FxPCnMKLw7() {
    const _0x5d3c33 = _0x58c636, _0x430634 = _0x481e4a;
    _keyStr = _0x430634(0x1e5, 'm!Od'), this[_0x430634(0x300, '3V$9')] = function (_0x36d568) {
        const _0x5a1630 = _0x430634, _0xd46e9b = _0x5544;
        var _0x401a06 = '', _0x3ac741, _0x49fbbe, _0x1c6ad4, _0x594abe, _0x3de366, _0x137f7d, _0x59bd0b,
            _0x206993 = 0x0;
        ...
        while (_0x206993 < _0x36d568['length']) {
            ...
            if (isNaN(_0x49fbbe)) _0x137f7d = _0x59bd0b = 0x40; else isNaN(_0x1c6ad4) && (_0x59bd0b = 0x40);
        ...
        const _0x67f590 = _0x430634, _0x5332f5 = _0x5d3c33;
        var _0x582b56 = '', _0x4a109b, _0x5bc9e0, _0x1ab833, _0x4f3c9b, _0x3eb183, _0x28486a, _0x47de89,
            _0x4d1a66 = 0x0;
        ...
        const _0x3cb0cb = _0x430634, _0x2087c5 = _0x5d3c33;
    ...
    return _0x5544 = function (_0x55449f, _0x2a867c) {
        ...
        if (_0x5544['tvcORe'] === undefined) {
            var _0x1700c9 = function (_0x3563fe) {
                ...
                for (let _0xa03ff3 = 0x0, _0x1a8333 = _0x75f235['length']; _0xa03ff3 < _0x1a8333; _0xa03ff3++) {
                    _0x10220e += '%' + ('00' + _0x75f235['charCodeAt'](_0xa03ff3)['toString'](0x10))['slice'](-0x2);
                }
                return decodeURIComponent(_0x10220e);
            };
            _0x5544['nOFGHF'] = _0x1700c9,
                _0x248755 = arguments,
                _0x5544['tvcORe'] = !![];
...
function rc4(_0xa24583, _0x5a4b85) {
    const _0xde4b75 = _0x58c636, _0x311895 = _0x481e4a;
    var _0xb26127 = Array(0x100), _0x5868be = Array(_0xa24583[_0x311895(0x1f8, 'hsug')]);
    ...
    for (var _0x43226b = 0x0; _0x43226b < _0x5868be[_0x311895(0x32c, 'MBt&')]; _0x43226b++) {
        var _0x187bf0 = (_0x187bf0 + 0x1) % 0x100, _0x4f6282 = (_0x4f6282 + _0xb26127[_0x187bf0]) % 0x100,
            _0x5e2007 = _0xb26127[_0x187bf0];
        _0xb26127[_0x187bf0] = _0xb26127[_0x4f6282], _0xb26127[_0x4f6282] = _0x5e2007;
